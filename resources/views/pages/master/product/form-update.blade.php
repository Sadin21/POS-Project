        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card border-0 p-4">
                ...
                <div class="d-flex pb-5 gap-5">
                    ...
                    <input type="text" placeholder="Masukkan Nama Barang" class="form-control" id="name" name="name" required value="">
                </div>
                ...
                <div class="d-flex pb-5 gap-5">
                    ...
                    <div class="flex-grow-1 d-flex align-items-center">
                        <div class="flex-grow-1 pe-4">
                            <input type="text" placeholder="Masukkan Kode Barang" class="form-control" name="code" id="code" required value="">
                        </div>
                ...
                <div class="d-flex pb-5 gap-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" placeholder="Masukkan Harga Barang" class="form-control" id="sale_price" name="sale_price" required value="" aria-describedby="sale_price">
                    </div>
                </div>
                ...
                <div class="d-flex pb-5 gap-5">
                    ...
                    <input type="number" placeholder="Masukkan Jumlah Barang" class="form-control" id="qty" name="qty" required value="">
                </div>
