...
<form action="{{ route('user.'. $mode, $mode === 'update'? [ 'nip' => $user->nip ] : null) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row d-flex gap-2">
        <div class="col" >
            <div class="card border-0 p-4" style="height: 70vh">
                {{-- <div class="fw-medium pb-5 f18">Informasi Akun</div> --}}
        ...
        <div class="col">
            <div class="card border-0 p-4 d-flex flex-column w-full"  style="height: 70vh">
